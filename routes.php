...
if(isset($_SESSION["USER_ID"])){
  ...
  $controllers['articles'] = array_merge($controllers['articles'], ['create'], ['myArticles'], ['edit'], ['store'], ['update'], ['delete']); // TODO: 'list', 'store', 'edit', 'update', 'delete'
